...
class TestCalibrationMetrics:
    ...
    def test_calibration_metrics_computation(self):
        ...
        results = [
            CalibrationResult(task_id="1", confidence_score=0.9, is_correct=True, 
                            confidence_bucket="high", calibration_error=0.1),
            CalibrationResult(task_id="2", confidence_score=0.9, is_correct=False,
                            confidence_bucket="high", calibration_error=0.9),
            CalibrationResult(task_id="3", confidence_score=0.3, is_correct=True,
                            confidence_bucket="low", calibration_error=0.7),
            CalibrationResult(task_id="4", confidence_score=0.5, is_correct=True,
                            confidence_bucket="medium", calibration_error=0.5),
        ]
