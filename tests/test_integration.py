...
class TestMatching:
    ...
    def test_extract_key_terms(self):
        ...
        terms = extract_key_terms("The protein kinase phosphorylates downstream targets", min_length=5, max_terms=3)
        assert len(terms) <= 3
...
class TestDashboard:
    ...
    def test_generate_dashboard(self):
        ...
        data = {
            "metadata": {"model": "test-model", "data_tier": "base", "timestamp": "2025-01-01T00:00:00"},
            "results": [
                {
                    "component": "adversarial",
                    "num_tasks": 2,
...
class TestRegistry:
    ...
    def test_register_custom(self):
        from bioeval.registry import REGISTRY, register_component, unregister_component, ComponentInfo
...
class TestSimulation:
    ...
    def test_simulation_good_quality(self):
        ...
        for comp_result in result["results"]:
            errors = [r for r in comp_result["results"] if isinstance(r, dict) and "error" in r and "score" not in r]
